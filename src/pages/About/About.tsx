...
function About() {
	return (
		//fade in animation component level to prevent retrigger from layout
					...
					<main className="font-marmelad flex h-full flex-col justify-center p-2 lg:w-[60rem] lg:p-0 lg:pl-32 xl:w-[70rem] xl:pl-40">
						<div>
							...
							<p className="text-text mt-4 p-1 leading-8 lg:pr-[19rem] xl:pr-[27rem]">
								If you haven't noticed yet, I'm fond of the color green. But beside
								my love for shades, I'm a professional Learning & Design Specialist
								— and hopefully an author! I was born and raised in New York City,
								which taught me all about how to learn a thing or two, write a good
								story, and enjoy a nice slice of pizza. Now I live and work in New
								Jersey with my lovely cat, Wizard.
							</p>
						</div>
